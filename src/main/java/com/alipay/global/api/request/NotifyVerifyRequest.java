...
public class NotifyVerifyRequest extends AlipayRequest {
     ...
     * notify_verify
     */
    private String service = "notify_verify";
    ...
    public Map<String, String> parameters() {
        ...
        if (notify_id != null && !notify_id.equals("") && !notify_id.equals("null")) {
            para.put("notify_id", notify_id);
        }
