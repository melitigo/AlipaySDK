...
public class AlipayAcquireOverseasSpotPayHkRequest extends AlipayRequest {
...
Otherwise, it returns INVALID_PARAMETER
    ...
    /**
     * 字段描述：商品说明，会显示在买家手机app的账单详情中的“商品說明”中。
     * Description: The name of the transaction, which is to be shown in the “商品說明”of Alipay transaction record for Alipay app.
    ...
    /**
     * 字段描述：同total_fee，交易金额，范围：0.01-100000000.00。 取小数点后两位。
    ...
    /**
     * 字段描述：订单信息
     * Description: Detailed transaction product information or industry content information.
     * Example: 
     * 
     */
