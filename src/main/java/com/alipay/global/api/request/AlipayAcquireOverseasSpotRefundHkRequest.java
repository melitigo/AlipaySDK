...
public class AlipayAcquireOverseasSpotRefundHkRequest extends AlipayRequest {
...
If the value is Y, there is only asynchronous return, which means that the refund will be synchronized, and there is no round-trip process.
    ...
    public void setRefundReson(String refund_reson) {
        if (refund_reson != null) {
            this.refund_reson = refund_reson.trim();
        }
    }
    ...
    public Map<String, String> parameters() {
        ...
        if (refund_reson != null && !refund_reson.equals("") && !refund_reson.equals("null")) {
            para.put("refund_reson", refund_reson);
        }
