...
public class AlipayAcquirePrecreateThirdPartyRequest extends AlipayRequest {
     ...
     */
    private String service = "alipay.acquire.precreate";
...
Otherwise, it returns INVALID_PARAMETER
     ...
     * 
     */
    private String qr_code_it_b_pay;
    ...
    public void setQrCodeItBPay(String qr_code_it_b_pay) {
        if (qr_code_it_b_pay != null) {
            this.qr_code_it_b_pay = qr_code_it_b_pay.trim();
        }
    }
    ...
    public String getQrCodeItBPay() {
        return qr_code_it_b_pay;
    }
    ...
    public Map<String, String> parameters() {
        ...
        if (qr_code_it_b_pay != null && !qr_code_it_b_pay.equals("") && !qr_code_it_b_pay.equals("null")) {
            para.put("qr_code_it_b_pay", qr_code_it_b_pay);
        }
