...
public class CreateForexTradeWapRequest extends AlipayRequest {
     ...
     */
    private String service = "create_forex_trade_wap";
...
* Sum of amount should be less or equal to the payment's total_fee or rmb_fee.
    ...
    public void setPay(String app_pay) {
        if (app_pay != null) {
            this.app_pay = app_pay.trim();
        }
    }
    ...
    public Map<String, String> parameters() {
        ...
        if (app_pay != null && !app_pay.equals("") && !app_pay.equals("null")) {
            para.put("app_pay", app_pay);
        }
