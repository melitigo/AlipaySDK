...
import com.alipay.global.api.request.ForexLiquidationFileRequest;
...
public class ForexLiquidationFileSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        ForexLiquidationFileRequest alipayRequest = new ForexLiquidationFileRequest();

        
        alipayRequest.setStartDate("20190601");
        alipayRequest.setEndDate("20190603");
