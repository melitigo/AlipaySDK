...
import com.alipay.global.api.request.AlipayAcquireCancelRequest;
...
public class AlipayAcquireCancelSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayAcquireCancelRequest alipayRequest = new AlipayAcquireCancelRequest();
