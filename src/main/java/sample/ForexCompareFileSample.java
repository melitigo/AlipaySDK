...
import com.alipay.global.api.request.ForexCompareFileRequest;
...
public class ForexCompareFileSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        ForexCompareFileRequest alipayRequest = new ForexCompareFileRequest();
