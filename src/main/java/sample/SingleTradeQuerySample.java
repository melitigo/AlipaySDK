...
import com.alipay.global.api.request.SingleTradeQueryRequest;
...
public class SingleTradeQuerySample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        SingleTradeQueryRequest alipayRequest = new SingleTradeQueryRequest();
