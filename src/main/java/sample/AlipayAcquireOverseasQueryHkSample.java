...
import com.alipay.global.api.request.AlipayAcquireOverseasQueryHkRequest;
...
public class AlipayAcquireOverseasQueryHkSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayAcquireOverseasQueryHkRequest alipayRequest = new AlipayAcquireOverseasQueryHkRequest();
