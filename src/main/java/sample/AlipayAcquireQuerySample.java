...
import com.alipay.global.api.request.AlipayAcquireQueryRequest;
...
public class AlipayAcquireQuerySample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayAcquireQueryRequest alipayRequest = new AlipayAcquireQueryRequest();
