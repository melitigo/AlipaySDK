...
import com.alipay.global.api.request.AlipayAcquireCancelHkRequest;
...
public class AlipayAcquireCancelHkSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayAcquireCancelHkRequest alipayRequest = new AlipayAcquireCancelHkRequest();
