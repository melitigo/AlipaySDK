...
import com.alipay.global.api.request.AlipayDutCustomerAgreementPageSignRequest;
...
public class AlipayDutCustomerAgreementPageSignSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayDutCustomerAgreementPageSignRequest alipayRequest = new AlipayDutCustomerAgreementPageSignRequest();

        
        alipayRequest.setProductCode("GENERAL_WITHHOLDING_P");
