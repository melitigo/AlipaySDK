...
import com.alipay.global.api.request.AlipayAcquireCreateRequest;
...
public class AlipayAcquireCreateSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayAcquireCreateRequest alipayRequest = new AlipayAcquireCreateRequest();
