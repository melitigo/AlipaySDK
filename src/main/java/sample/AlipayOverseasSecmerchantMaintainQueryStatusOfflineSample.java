...
import com.alipay.global.api.request.AlipayOverseasSecmerchantMaintainQueryStatusOfflineRequest;
...
public class AlipayOverseasSecmerchantMaintainQueryStatusOfflineSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayOverseasSecmerchantMaintainQueryStatusOfflineRequest alipayRequest = new AlipayOverseasSecmerchantMaintainQueryStatusOfflineRequest();
        ...
        alipayRequest.setPaymentMethod("INSTORE_PAYMENT");
