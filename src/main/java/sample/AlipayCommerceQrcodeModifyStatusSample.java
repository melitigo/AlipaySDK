...
import com.alipay.global.api.request.AlipayCommerceQrcodeModifyStatusRequest;
...
public class AlipayCommerceQrcodeModifyStatusSample {
    public static void main(String[] args) throws AlipayApiException, UnsupportedEncodingException {
        ...
        AlipayCommerceQrcodeModifyStatusRequest alipayRequest = new AlipayCommerceQrcodeModifyStatusRequest();
